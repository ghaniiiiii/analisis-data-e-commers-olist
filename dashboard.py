...
def load_data():
    ...
    order_payment_df = pd.read_csv("https://raw.githubusercontent.com/Fanbop/ProyekAnalisisData/main/data/order_payments_dataset.csv")
    order_review_df = pd.read_csv("https://raw.githubusercontent.com/Fanbop/ProyekAnalisisData/main/data/order_reviews_dataset.csv")
